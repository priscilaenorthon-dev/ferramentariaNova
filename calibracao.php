...
<div class="content-area calibracao-page">
    <div class="page-header with-actions">
        ...
        <div class="page-actions">
            <form method="post" action="calibracao_export.php" target="_blank">
                <input type="hidden" name="tipo" value="excel">
                <button class="btn-ghost" type="submit">📄 Exportar Excel</button>
            </form>
            <form method="post" action="calibracao_export.php" target="_blank">
                <input type="hidden" name="tipo" value="pdf">
                <button class="btn-ghost" type="submit">📝 Exportar PDF</button>
            </form>
        </div>
    </div>
...
<style>
    ...
    .page-actions form { display: inline; margin-left: 0.4rem; }
    .summary-grid {
        display: grid;
